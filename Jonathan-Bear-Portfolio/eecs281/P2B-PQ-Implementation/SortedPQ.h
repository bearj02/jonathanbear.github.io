...
public:
    ...
    virtual void push(const TYPE &val) {
        ...
        else if(this->compare(data[data.size()-1],val)) data.push_back(val);
        else data.insert(lower_bound(data.begin(),data.end(),val,this->compare),val);
    ...
    virtual void updatePriorities() {
        // TODO: Implement this function
        sort(data.begin(),(data.begin()+data.size()),this->compare);
    } // updatePriorities()
